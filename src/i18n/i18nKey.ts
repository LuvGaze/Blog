enum I18nKey {
	...
	musicPageDescription = "musicPageDescription",
	musicPageTip = "musicPageTip",

	// 网站导航页面
	projects = "projects",
	projectsTitle = "projectsTitle",
	projectsDescription = "projectsDescription",
	projectsNoData = "projectsNoData",

	// 笔记本页面
	notebooks = "notebooks",
	notebooksTitle = "notebooksTitle",
	notebooksDescription = "notebooksDescription",
	notebooksNoData = "notebooksNoData",
	notebooksEmptyTip = "notebooksEmptyTip",

	// 日常规划页面
	routines = "routines",
	routinesTitle = "routinesTitle",
	routinesDescription = "routinesDescription",
	routinesNoData = "routinesNoData",
