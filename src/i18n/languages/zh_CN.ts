...
export const zh_CN: Translation = {
	...
	[Key.bangumiFetchErrorDesc]:
		"构建时从 Bangumi image-api 获取数据失败，该页面内容暂不可用。",
	...
	[Key.animeNotConfiguredDesc]:
		"请在 src/config/siteConfig.ts 中配置 Bilibili UID 或 TMDB image-api Key",
	...
	[Key.movies]: "影视",
	[Key.moviesTitle]: "影视",
	[Key.moviesSubtitle]: "记录看过的影视作品。",
	[Key.moviesNoData]: "暂无影视记录",
	...
	[Key.games]: "游戏",
	[Key.gamesTitle]: "游戏",
	[Key.gamesSubtitle]: "记录玩过的游戏。",
	[Key.gamesNoData]: "暂无游戏记录",
	...
	[Key.musicPageDescription]: "收录个人喜欢的音乐歌单，支持多平台切换",
	[Key.musicPageTip]: "选择歌单即可开始播放",

	// 网站导航页面
	[Key.projects]: "网站导航",
	[Key.projectsTitle]: "网站导航",
	[Key.projectsDescription]: "收录个人网站、常用工具和收藏网站",
	[Key.projectsNoData]: "暂无收录的网站",
	...
	// 日常规划页面
	[Key.routines]: "日常规划",
	[Key.routinesTitle]: "日常规划",
	[Key.routinesDescription]: "记录和规划生活中的各项事务",
	[Key.routinesNoData]: "还没有日常规划",

	// 足迹页面
	[Key.places]: "去过的地方",
	[Key.placesTitle]: "去过的地方",
	[Key.placesDescription]: "足迹地图与旅行记录",
